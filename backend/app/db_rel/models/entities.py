...
class AthleteProfile(TimestampMixin, Base):
    ...
    sport_position: Mapped[str | None] = mapped_column(String(100), nullable=True)
    season_phase: Mapped[str | None] = mapped_column(String(50), nullable=True)
    weekly_competitions: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    performance_priorities: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
